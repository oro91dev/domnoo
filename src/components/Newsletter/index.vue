    ...
    <div class="container newsl_container">
        ...
        <div class="small">
            <p>Lorem ipsum dolor sit amet consectetur,
                 adipisicing elit. Ea sunt reprehenderit ad 
                 aspernatur quidem at fugiat perspiciatis, 
                 sequi accusantium animi a unde nobis sint,
                  magnam adipisci eos esse, deleniti hic.</p>
        </div>
    </div>
</template>
